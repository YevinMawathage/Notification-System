    ...
    try {
      ...
      if (!res.ok) {
        ...
        try {
          ...
          errorMessage = "The email or password you entered does not match, or the account does not exist.";
        }
      ...
      if (err instanceof Error) {
        setAlertInfo({ isOpen: true, title: "Login Failed", message: err.message, type: "error" });
      } else {
        setAlertInfo({ isOpen: true, title: "Login Failed", message: "An unknown error occurred", type: "error" });
      }
    } finally {
      setLoading(false);
    }
          ...
          <div className="max-w-[360px] mx-auto w-full">
            ...
            <div className="mt-8 text-center">
              <p className="text-sm font-medium text-zinc-500">
                ...
                <Link href="/signup" className="text-indigo-400 hover:text-indigo-300 font-bold transition-colors underline decoration-2 underline-offset-4">
                  Sign Up
                </Link>
              </p>
            </div>
          ...
          <div className="w-full h-full rounded-[2rem] overflow-hidden relative shadow-[inset_0_0_50px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute bottom-8 left-8 right-8 bg-zinc-900/40 backdrop-blur-xl border border-white/10 p-6 rounded-2xl">
              <p className="text-sm text-zinc-200 font-medium leading-relaxed">
                Connect and get realtime alerts for your favorite anime drops. Log in to track your personal watchlist seamlessly.
              </p>
